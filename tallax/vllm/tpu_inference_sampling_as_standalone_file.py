"""
Standalone script containing the sample function from tpu_inference.layers.jax.sample.sampling

This script extracts the sample function along with all necessary internal dependencies,
inlining code from tpu_inference modules while preserving external library imports.
"""
...
# ============================================================================
# From tpu_inference.layers.common.sharding
# ============================================================================
...
# ============================================================================
# From tpu_inference.layers.common.binary_search
# ============================================================================
...
# ============================================================================
# From tpu_inference.layers.jax.sample.sampling_metadata
# ============================================================================
...
# ============================================================================
# From tpu_inference.layers.jax.sample.sampling
# ============================================================================
...
def sample(
  ...
  return jnp.where(
    tpu_sampling_metadata.temperature < _SAMPLING_EPS,
    greedy_sampled,
    next_tokens,
  )
