...
@pytest.mark.parametrize("shape", [
    (8, 16), (8, 64), (8, 128),  # Within NUM_LANES
    (8, 256), (8, 512), (8, 1024), (8, 2048),  # Cross-lane (> NUM_LANES)
    (16, 128), (32, 128), (64, 128), (128, 128), (128, 256),  # Various batch sizes
])
...
@pytest.mark.parametrize("shape", [(8, 128), (8, 2048), (16, 64), (32, 128), (128, 256)])
@pytest.mark.parametrize("dtype", [jnp.int32, jnp.float32])
@pytest.mark.parametrize("descending", [False, True])
